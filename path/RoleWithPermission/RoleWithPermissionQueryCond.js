...
router.post("/company/RoleWithPer/queryWithCond", [
    check("number")
        .notEmpty()
        .isNumeric()
    ...
    rpcIns.queryRolePermissionsByCondition(req.body["number"], req.body["pages"], req.body["keys"], req.body["value"],(result,data,count) => {
        console.log(result)
        if (result === 1) {
